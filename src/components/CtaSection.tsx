...
const CtaSection = ({ className }: { className?: string }) => {
  ...
  return (
    ...
    >
      <div
        className={`absolute -top-4 sm:-top-16 lg:top-12 left-4 sm:left-8 lg:left-12 2xl:left-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 2xl:w-[400px] 2xl:h-[400px] max-h-[400px] transition-all duration-[1500ms] ease-in-out ${
          inView
      ...
      <div
        className={`absolute -bottom-4 sm:-bottom-16 lg:bottom-12 right-4 sm:right-8 lg:right-12 2xl:right-0 w-48 h-48 sm:w-64 sm:h-64 lg:w-80 lg:h-80 2xl:w-[400px] 2xl:h-[400px] max-h-[400px] transition-all duration-[1500ms] ease-in-out ${
          inView
