...
const TeamMember = ({
  ...
  return (
    ...
    >
      ...
      <h4 className='text-end text-xl lg:text-2xl mt-4 underlined before:right-0 before:left-auto !absolute bottom-4 right-4 lg:bottom-8 lg:right-8 opacity-0 invisible translate-y-2 group-hover:opacity-100 group-hover:visible group-hover:translate-y-0 transition-all duration-300 ease-in-out z-20'>
        {member.name}
      </h4>
    </div>
  );
